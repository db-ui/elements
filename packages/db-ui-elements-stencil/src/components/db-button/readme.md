...
| `size`           | `size`           | The size attribute specifies the button size out of three sizes.                                                                                                                                   | `"large" \| "medium" \| "small" \| "xlarge" \| "xsmall" \| "xxsmall"`       | `undefined` |
| `state`          | `state`          | The state attribute provides the possibility to define (currently only) the loading state.                                                                                                         | `"loading"`                                                                 | `undefined` |
