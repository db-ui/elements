...
You could set the attribute `label-hidden="true"` for the rare case that you would want to visually hide the textual label for a radio element.

<Canvas>
<db-radio label="Radio-01" name="radio-name" value="radio-01" label-hidden="true"></db-radio>
</Canvas>
