import{M as s,C as t,e as r}from"./chunk-HLWAVYOI-Dpq47VA4.js";import{j as n}from"./jsx-runtime-A2EuhNPH.js";import{u as a}from"./index-DNMuPLEI.js";import"./iframe-C2sxNleA.js";import"../sb-preview/runtime.js";import"./doctrine-DcUutl77.js";import"./index-DrFu-skq.js";const d=`# db-icon
...
`;function c(i){const e=Object.assign({p:"p",code:"code",a:"a"},a(),i.components);return n.jsxs(n.Fragment,{children:[n.jsx(s,{title:"04-Data-Display/Icon/Intro"}),`
`,n.jsx("db-headline",{variant:"1",children:"<db-icon>"}),`
`,n.jsxs(e.p,{children:["The ",n.jsx(e.code,{children:"<db-icon></db-icon>"})," is based on the design language of Deutsche Bahn. You can try out on ",n.jsx(e.a,{href:"?path=/story/db-icon--live-demo",children:"Icon Live Demo"})," Page."]}),`
