import{M as d,C as a,e as l}from"./chunk-HLWAVYOI-Dpq47VA4.js";import{c as o}from"./mockData-CeVrjjfO.js";import{j as e}from"./jsx-runtime-A2EuhNPH.js";import{u as s}from"./index-DNMuPLEI.js";import"./iframe-C2sxNleA.js";import"../sb-preview/runtime.js";import"./doctrine-DcUutl77.js";import"./index-DrFu-skq.js";const c=`# db-sidenavi
...
`,e.jsx(a,{mdxSource:'<db-sidenavi><db-link rel="index" href="#" aria-current="page">{"Startseite"}</db-link><db-link rel="documents" href="#">{"Dokumente"}</db-link><db-link icon="settings" href="#">{"Einstellungen"}</db-link><db-link icon="chat" href="#">{"Nachrichten"}</db-link><db-link rel="calendar" href="#">{"Kalender"}</db-link><db-link rel="help" href="#">{"Frage & Hilfe"}</db-link></db-sidenavi>',children:e.jsxs("db-sidenavi",{children:[e.jsx("db-link",{rel:"index",href:"#","aria-current":"page",children:"Startseite"}),e.jsx("db-link",{rel:"documents",href:"#",children:"Dokumente"}),e.jsx("db-link",{icon:"settings",href:"#",children:"Einstellungen"}),e.jsx("db-link",{icon:"chat",href:"#",children:"Nachrichten"}),e.jsx("db-link",{rel:"calendar",href:"#",children:"Kalender"}),e.jsx("db-link",{rel:"help",href:"#",children:"Frage & Hilfe"})]})}),`
`,e.jsx("db-headline",{children:"sidenavi with data"}),`
`,e.jsx(a,{mdxSource:"<db-sidenavi data={mockDataIcon()} />",children:e.jsx("db-sidenavi",{data:o()})}),`
