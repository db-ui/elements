import{M as o,C as a,e as l}from"./chunk-HLWAVYOI-Dpq47VA4.js";import{m as d}from"./mockData-CeVrjjfO.js";import{j as e}from"./jsx-runtime-A2EuhNPH.js";import{u as s}from"./index-DNMuPLEI.js";import"./iframe-C2sxNleA.js";import"../sb-preview/runtime.js";import"./doctrine-DcUutl77.js";import"./index-DrFu-skq.js";const c=`# db-metanavigation
...
`,e.jsx(a,{mdxSource:'<db-metanavigation><db-link icon="settings" href="#">{"Einstellungen"}</db-link><db-link icon="chat" icononly href="#">{"Nachrichten"}</db-link></db-metanavigation>',children:e.jsxs("db-metanavigation",{children:[e.jsx("db-link",{icon:"settings",href:"#",children:"Einstellungen"}),e.jsx("db-link",{icon:"chat",icononly:!0,href:"#",children:"Nachrichten"})]})}),`
...
`})}),`
`,e.jsx(l,{children:c})]})}function h(t={}){const{wrapper:n}=Object.assign({},s(),t.components);return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}const m=()=>{throw new Error("Docs-only story")};m.parameters={docsOnly:!0};const i={title:"02-Navigation/Meta Navigation/Intro",tags:["stories-mdx"],includeStories:["__page"]};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:h};const y=["__page"];export{y as __namedExportsOrder,m as __page,i as default};
