...
This project was originially generated with [Angular CLI](https://github.com/angular/angular-cli) version 10.0.5, and updated by Angular CLI 15.2.9. We're also [hosting the build on GitHub pages](https://db-ui.github.io/elements/angular-lts-minus-1-showcase/#/).
